...
namespace parser
{
    public class NinDocument
    {
        ...
        public NinDocument(DocumentUri documentUri)
        {
        ...
        public IEnumerable<NinValue> GetValues()
        {
            EnsureParsed();
            return _values.Values;
        }

        public IEnumerable<NinSection> GetSections()
        {
            EnsureParsed();
            return _sections;
        }
        ...
        private void EnsureParsed()
        {
            ...
            var values = ImmutableDictionary<string, NinValue>.Empty.ToBuilder();
    ...
    public record NinSection(string Section, Range Location);
}
